...
const BarberHeader: React.FC = () => {
  ...
  return (
    <>
      <header className="glass-effect-strong border-b border-border/50 sticky top-0 z-40">
        <div className="container mx-auto flex justify-between items-center p-4 md:p-6">
          <div className="flex items-center gap-3 md:gap-4">
            <div className="w-10 h-10 md:w-12 md:h-12 glass-effect rounded-xl flex items-center justify-center">
              <Scissors className="w-5 h-5 md:w-6 md:h-6 text-accent" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-2 md:gap-4">
            <div className="hidden lg:flex items-center gap-3 glass-effect px-3 md:px-4 py-2 rounded-lg">
              <UserCog className="w-4 h-4 md:w-5 md:h-5 text-accent" />
              <span className="text-sm font-medium text-muted-foreground">Dashboard Barbeiro</span>
            </div>
            ...
            <Button 
              ...
              className="border-border/50 hover:border-border bg-transparent hidden md:flex"
            >
